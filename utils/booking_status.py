...
STATUS_BOOKING_TYPE = {
    ACTUAL_BOOKING:(NEW, CONFIRMED, NOSHOW_USER, NOSHOW_PROVIDER, COMPLETED, COMPLETED_UNPAID, WATCH, NETWORK_ERROR), 
...
def get_active_user_status():
    return (NEW, CONFIRMED, NOSHOW_PROVIDER, NOSHOW_USER, COMPLETED, COMPLETED_UNPAID, WATCH, NETWORK_ERROR)
