...
from tg.constants import POSTFIX_NOTIFICATION_CHANNAL
...
async def send_notification_to_channel(update: Update, context: ContextTypes.DEFAULT_TYPE, msg:str):
    ...
    if channel_id:
        ...
        message = POSTFIX_NOTIFICATION_CHANNAL.format(msg=msg, first_name = user.first_name, username = user.username)
