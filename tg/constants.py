...
USER_BOOKING_LIST = "Ваши бронирования актуальные на {date}\n🟢 - подтвержденная бронь\n🟡 - заявка не подтверждена\n🔴 - заявка отклонена\n⚪ - отмена пользователя\n⚫ - отмена админа\n🚫 - пользователь не пришел\n✖️ - исполнитель не пришел\n✅ - завершен\n💳 - завершен(не оплачен)\n👁️ - наблюдаете\n🌐 - сбой сети\n⚠️ - сбой"
SELECTE_DATE = "Выберите 🗓️ дату:"
SELECTE_TIME = "Вы выбрали 🗓️ {date}\nВыберите 🕒 время\n⚠️ - время скорее всего занято, но вы можете запросить уведомление, если оно освободиться"
CONFIRM_BOOKING_SLOT = "Подтвердить запись:\n🗓️ {date}"
OCCUPIED_SLOT_CURRENT_USER = "⚠️ Вы уже забронировали данный слот:\n🗓️ {date}"
WATCHING_SLOT_CURRENT_USER = "⚠️ Вы уже отслеживаете данный слот:\n🗓️ {date}"
OCCUPIED_SLOT = "🚫 Слот занят другм пользователем:\n🗓️ {date}\nВы можете нажать '🔔 Уведомить', что бы получить сообщение, если он освободиться"
SUCCESS_BOOKING = "✅ Вы успешно забронировали время:\n🗓️ {date}"
SUCCESS_WATCHING = "✅ Вы получите уведомление, если слот освободиться:\n🗓️ {date}"
DETAILS_BOOKING = "Ваше бронирование\nКогда: {date}\nСтатус: {icon}\nВремя бронирования:{created_at}"
CONFIRM_UNBOOKING = "Подтвердить удалние брони:\n🗓️ {date}"
CONFIRM_UNWATCHING = "Подтвердить сянтие наблюдения со слота:\n🗓️ {date}"
SUCCESS_UNBOOKING = "✅ Вы отменили бронирование\n🗓️ {date}"
SUCCESS_UNWATCHING = "✅ Вы отменили наблюдение\n🗓️ {date}"
...
BOT_STOP_NOTIFICATION = (
            "🤖 <b>Начата остановка бота {date}!</b>\n"
            "🆔 ID: <code>{bot_id}</code>\n"
            "👤 Имя: @{bot_username}\n"
            "❌ Бот завершате работу!"
        )
...
BOOKING_STATUS_CHANGED = "✅ Статус бронирования успешно изменен"
BOOKING_STATUS_ERROR = "❌ Неизвестный статус"
...
SELECT_USER = "👤 Выбирете пользователя"

POSTFIX_NOTIFICATION_CHANNAL = "{msg}\nПользователь {first_name} (@{username})"

SELECT_FIRST_DAY = "Выберите начало 🗓️\n🟥 - выбранный день\n\n🟨 - текущая неделя\n\n🟧 - прошлая неделя\n\n🟪 - будущая неделя"
SELECT_LAST_DAY = "Выберите конец 🗓️\n🟥 - выбранный день\n\n🟨 - текущая неделя\n\n🟧 - прошлая неделя\n\n🟪 - будущая неделя"